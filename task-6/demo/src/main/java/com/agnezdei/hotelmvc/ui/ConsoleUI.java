...
public class ConsoleUI {
    ...
    private void exportRooms() {
        System.out.print("Введите путь для сохранения файла (например: rooms.csv): ");
    ...
    private void exportServices() {
        System.out.print("Введите путь для сохранения файла (например: services.csv): ");
        String filePath = scanner.nextLine();
    ...
    private void exportGuests() {
        System.out.print("Введите путь для сохранения файла (например: guests.csv): ");
        String filePath = scanner.nextLine();
    ...
    private void importRooms() {
        System.out.print("Введите путь к файлу для импорта комнат: ");
        String filePath = scanner.nextLine();
    ...
    private void importServices() {
        System.out.print("Введите путь к файлу для импорта услуг: ");
        String filePath = scanner.nextLine();
    ...
    private void importGuests() {
        System.out.print("Введите путь к файлу для импорта гостей: ");
        String filePath = scanner.nextLine();
    ...
    private void importBookings() {
        System.out.print("Введите путь к файлу для импорта бронирований: ");
        String filePath = scanner.nextLine();
