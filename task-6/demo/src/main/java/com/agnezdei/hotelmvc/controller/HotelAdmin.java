...
public class HotelAdmin {
    ...
    public HotelAdmin(Hotel hotel) {
        ...
        this.csvImporter = new CsvImporter(hotel);
    }
    ...
    public String importRoomsFromCsv(String filePath) {
        try {
            return csvImporter.importRooms(filePath);
        } catch (Exception e) {
    ...
    public String importServicesFromCsv(String filePath) {
        try {
            return csvImporter.importServices(filePath);
        } catch (Exception e) {
            return "Ошибка импорта: " + e.getMessage();
        }
    }
    ...
    public String importGuestsFromCsv(String filePath) {
        try {
            return csvImporter.importGuests(filePath);
        } catch (Exception e) {
            return "Ошибка импорта: " + e.getMessage();
        }
    }
    ...
    public String importBookingsFromCsv(String filePath) {
        try {
            return csvImporter.importBookings(filePath);
        } catch (Exception e) {
            return "Ошибка импорта: " + e.getMessage();
        }
    }
