...
public class HotelApp {
    public static void main(String[] args) {
        ...
        try {
            ...
            // System.out.println(admin.exportRoomsToCsv("data/rooms.csv"));
            // System.out.println(admin.exportServicesToCsv("data/services.csv"));
            // System.out.println(admin.exportGuestsToCsv("data/guests.csv"));
            // System.out.println(admin.exportBookingsToCsv("data/bookings.csv"));
