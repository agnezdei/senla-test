...
import com.agnezdei.hotel.model.Booking;
import com.agnezdei.hotel.model.Guest;
import com.agnezdei.hotel.model.Hotel;
import com.agnezdei.hotel.model.Room;
import com.agnezdei.hotel.model.RoomType;
import com.agnezdei.hotel.model.ServiceCategory;
...
public class TestHotel {
    public static void main(String[] args) {
        ...
        admin.addRoom("201", RoomType.BUSINESS, 3500, 1, 4);
        admin.addRoom("202", RoomType.BUSINESS, 4000, 2, 4);
        ...
        admin.addService("СПА", 1500, ServiceCategory.COMFORT);
        admin.addService("Массаж", 1200, ServiceCategory.COMFORT);
